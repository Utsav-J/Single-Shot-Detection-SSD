...
transform = BaseTransform(net.size, (103/256.0,117/256.0,123/256.0))

reader = imageio.get_reader(R'Udemy\Code for Windows\funny_dog.mp4')
fps = reader.get_meta_data()['fps']
writer = imageio.get_writer(R'Udemy\Code for Windows\funny_dog.mp4',fps = fps)   
